...
CREATE TABLE
    Game (
        ...
        rating VARCHAR(10),
        genre VARCHAR(50) publisher VARCHAR(255),
        release_date DATE
    );
...
CREATE TABLE
    Player (
        ...
        game_id SERIAL REFERENCES Game(game_id) name VARCHAR(255) NOT NULL,
        date_of_birth DATE,
        email VARCHAR(255) UNIQUE,
        address TEXT username VARCHAR(50) UNIQUE
    );
...
CREATE TABLE
    Account (
        ...
        player_id SERIAL REFERENCES Player(player_id) balance DECIMAL(10, 2) DEFAULT 0.0,
